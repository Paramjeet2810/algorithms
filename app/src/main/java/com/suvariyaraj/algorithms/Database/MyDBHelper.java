...
/**
 * Created by GOODBOY-PC on 28/06/16.
 */
...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    protected static String DB_PATH = "data/data/com.suvariyaraj.algorithms/databases/";

    protected static String DB_NAME = "algorithms.sqlite3";
    ...
    public void copyCacheToMain(MyDBHelper objCache) throws IOException {
    ...
    public void backup() {
        try {
            ...
            if (sd.canWrite()) {
                String currentDBPath = "\\data\\com\\com.developer.goeducation.algorithm\\databases\\Codes.sqlite";
